...
target_base_dir = '/gemini-3/space/thu/hehaowei/modelscope_cache/datasets/fineweb_hhw_transformed'
...
def process_file(filename):
    ...
    try:
        ...
        if not file_path_in_url.startswith('sample/100BT'):
            return
        # print(file_path_in_url)
        if "001_00007.parquet" in file_path_in_url:
            print(file_path)
            return
        else:
            return
