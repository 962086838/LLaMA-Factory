...
from .telechat_hwmoe_pt import run_telechat_hwmoe_pt
...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "telechat_hwmoe_pt":
        run_telechat_hwmoe_pt(model_args, data_args, training_args, finetuning_args, callbacks)
    else:
