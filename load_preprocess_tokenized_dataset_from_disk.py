...
dataset = load_from_disk('/gemini/space/thu/receieve_wangzihan/Megatron-LM-core_r0.6.0_dropout_HWMoE/converted_dataset')  # 传入包含这些文件的目录路径
...
tokenizer = AutoTokenizer.from_pretrained('/gemini/space/thu/hehaowei/LLaMA-Factory/saves/TeleChat-1B-HWMoE/full/pt_origin_16machine_z2_continue_continue_continue/', trust_remote_code=True)
